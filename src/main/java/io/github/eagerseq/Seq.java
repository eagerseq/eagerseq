...
public interface Seq<E> extends Collection<E> {
    ...
    static <E> Seq<E> copyOf(Iterable<? extends E> iterable) {
        return new ArraySeq<>(Split.toArray(requireNonNull(iterable)));
    }
    ...
    static <E> Seq<E> copyOf(Iterator<? extends E> iterator) {
        return new ArraySeq<>(Split.toArray(requireNonNull(iterator)));
    }
    ...
    static <E> Seq<E> copyOf(Spliterator<? extends E> spliterator) {
        return new ArraySeq<>(Split.toArray(requireNonNull(spliterator)));
    }
    ...
    static <E> Seq<E> concat(
        ...
        return copyOf(Split.concat(Iterable::spliterator, iterables));
    }
    ...
    static <E> Seq<E> flatten(
        ...
        return copyOf(Split.flatten(
                iterables.spliterator(), Iterable::spliterator));
    }
    ...
    default Seq<E> sum(Iterable<? extends E> that) {
        requireNonNull(that);
        return copyOf(Split.concat(Iterable::spliterator, this, that));
    }
    ...
    default <R> Seq<R> flatMap(
        ...
        requireNonNull(mapper);
        return copyOf(Split.flatMap(
                spliterator(), mapper, Iterable::spliterator));
    }

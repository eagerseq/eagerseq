...
[`Stage.java`](../seq/src/main/java/io/github/jancellor/seq/Stage.java); the traversal
return contract belongs to
[`Source.forEachWhile`](../seq/src/main/java/io/github/jancellor/seq/Source.java).

...
- Read [CONTRIBUTING.md](CONTRIBUTING.md) before working in this repository.
  Read its linked references selectively when relevant to the task; they are
...
- Keep outstanding work in `TODO.md` and settled guidance in its appropriate
  reference. Do not create unsolicited conversation summaries or new design
  documents after a discussion; update the existing home for the information.
